...
export class UpdateProductComponent {
  ...
  ngOnInit(): void {
    this.updateProductForm = this.fb.group({
      ...
      duoPrice: [null, [Validators.required]],
      familyPrice: [null, [Validators.required]],
    });
    this.getProductById();
  ...
  updateProduct(): void {
    if (this.updateProductForm.valid) {
      ...
      formData.append('duoPrice', this.updateProductForm.get('duoPrice').value);
      formData.append('familyPrice', this.updateProductForm.get('familyPrice').value);
